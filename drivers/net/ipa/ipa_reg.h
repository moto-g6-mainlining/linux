...
enum ipa_reg_id {
	...
	SRC_RSRC_GRP_45_RSRC_TYPE,			/* IPA v3.0+, Not IPA v3.5+, IPA v4.5 */
	SRC_RSRC_GRP_67_RSRC_TYPE,			/* IPA v3.0+, Not IPA v3.5+ */
	DST_RSRC_GRP_01_RSRC_TYPE,			/* IPA v3.0+ */
	DST_RSRC_GRP_23_RSRC_TYPE,			/* IPA v3.0+ */
	DST_RSRC_GRP_45_RSRC_TYPE,			/* IPA v3.0+, Not IPA v3.5+, IPA v4.5 */
	DST_RSRC_GRP_67_RSRC_TYPE,			/* IPA v3.0+, Not IPA v3.5+ */
	...
	/* The IRQ registers are only used for DMA_EE_AP */
	IPA_IRQ_STTS,
	IPA_IRQ_EN,
	IPA_IRQ_CLR,
	IPA_IRQ_UC,					/* IPA v3.0+ */
...
extern const struct ipa_regs ipa_regs_v2_0;
extern const struct ipa_regs ipa_regs_v2_5;
extern const struct ipa_regs ipa_regs_v2_6l;
