 ...
 *
 * Immediate commands on IPA v3+ are represented by GSI transactions just
 * like other transfer requests, and use a single GSI TRE.  Each immediate
 ...
 * always issued using trans_commit_wait().
 */
